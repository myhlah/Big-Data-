    ...
    def main():
        ...
        with tabs[2]:
            ...
            st.write("""
                ...
                - **Mean Absolute Error (MAE)**:  Gives an indication of how close the predicted values are to the actual target values, on average. This is the average of the absolute differences between predicted and actual values. A lower MAE indicates that the model’s predictions are closer to the actual values.
